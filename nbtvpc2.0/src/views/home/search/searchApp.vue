<template>
  <div id="container">
    ...
    <div class="g-content g-content-footer" ref="size">
      ...
      <div class="g-search">
        <div class="crumb"><a href="./index.html">首页</a><span>&nbsp;&gt;&nbsp;</span><a href="./index.html">实体办学</a><span>&nbsp;&gt;&nbsp;</span><a href="javascript:void(0)">校园动态</a></div>
      ...
      <div class="page">
        ...
        <span>共{{Math.round(total / pageSize)+1}}页</span>
      </div>
