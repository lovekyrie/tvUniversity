        ...
        <div class="g-content">
            ...
            <div class="f-form">
                ...
                <div class="onelist clearfix">
                    <input type="text" placeholder="单行输入"><span>学生姓名：</span>
                </div>
                <div class="onelist clearfix">
                    <input type="text" placeholder="单行输入"><span>学员身份证号码：</span>
                </div>
                <div class="onelist clearfix">
                    <input type="text" placeholder="单行输入"><span>学员学号：</span>
                </div>
                <div class="onelist clearfix">
                    <input type="text" placeholder="单行输入"><span>联系电话：</span>
                </div>
            </div>
            <div class="f-paybtn">
