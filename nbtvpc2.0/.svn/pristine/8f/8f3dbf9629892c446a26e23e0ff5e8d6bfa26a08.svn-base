<template>
  <div>
    ...
    <div class="g-content" ref="size">
      ...
      <div class="g-search">
        <div class="crumb"><a href="../home/index.html">首页</a><span>&nbsp;&nbsp;&gt;&nbsp;&nbsp;</span><a href="javascript:void(0)">新闻动态</a></div>

        <div class="content">
          <a :href="'./imglist.html?id='+item.id" v-for="item in items" class="clearfix">
