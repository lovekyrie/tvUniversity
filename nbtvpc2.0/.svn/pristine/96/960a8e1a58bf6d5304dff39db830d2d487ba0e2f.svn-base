<template>
    <div>
        <!--弹窗-->
        <div class="pop-class" @click="successPop=false" v-show="successPop">
            <div>
        ...
        <div class="pop-class" @click="numPop=false" v-show="numPop">
            <div height="310px">
        ...
        <div class="pop-class" @click="rootPop=false" v-show="rootPop">
            <div height="310px">
                <img src="./img/warning.png" alt="">
                <p>只向在校学生开放！</p>
            </div>
        ...
        <div class="g-content" ref="size">
            ...
            <div class="g-search">
                <div class="crumb"><a href="../home/index.html">首页</a><span>&nbsp;&gt;&nbsp;</span><a href="./index.html">精彩活动</a><span>&nbsp;&gt;&nbsp;</span><a href="">活动详情</a><span>&nbsp;&gt;&nbsp;</span><a href="javascript:void(0)">参加报名</a>
                </div>
