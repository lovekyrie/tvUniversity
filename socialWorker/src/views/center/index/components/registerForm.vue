...
<template>
    <div v-if="len" id="container">
        ...
        <div class="g-content  g-content-footer" v-loading.fullscreen.lock="fullscreenLoading">
            ...
            <div class="f-form">
                <h3>报名表提交</h3>
                <div class="onelist clearfix" v-for="(list,index) in msglist" :key="index">
                    ...
                    <select v-if="list.arg2=='select'" v-model="formmsg[list.arg1]">
                        <option :value="list.nm" v-for="(list,index) in selectList" :key="index">{{list.nm}}</option>
                    </select>
