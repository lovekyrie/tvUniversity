          ...
          <div class="pwd-title">
            ...
            <el-form ref="form" :rules="rules" :model="form" label-width="120px">
                <el-form-item label="手机号码" prop="telPhone">
                    <el-input v-model="form.telPhone" placeholder="单行输入"></el-input>
                </el-form-item>
                <el-form-item label="验证码" prop="code" class="code">
                    <el-input v-model="form.code" placeholder="单行输入"></el-input><button>发送验证码</button>
                </el-form-item>
                <el-form-item label="密码" prop="passWord">
                    <el-input v-model="form.passWord" placeholder="单行输入"></el-input>
                </el-form-item>
                <el-form-item label="再次输入密码" prop="checkPass">
                    <el-input v-model="form.checkPass" placeholder="单行输入"></el-input>
                </el-form-item>
