    ...
    <div class="g-content" ref="size">
      <div class="login">
        ...
        <div class="onelist">
          <p>
            <span>身份证号：</span>
            <input type="text" placeholder="单行输入" v-model="card">
          </p>
        </div>
        <div class="onelist-s">
          <p>
        ...
        <div class="onelist">
          <p>
            <span>验证码：</span>
            <input type="text" placeholder="单行输入" v-model="yzm" style="width: 200px;">
        ...
        <div class="onelist">
          <p>
            <span>密码：</span>
            <input type="password" placeholder="单行输入" v-model="pass">
          </p>
        </div>
        <div class="onelist">
          <p>
            <span>再次输入密码：</span>
            <input type="password" placeholder="单行输入" v-model="checkPass">
          </p>
        </div>
        <div class="c-button">
