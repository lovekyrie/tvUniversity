  ...
  <div id="container">
    ...
    <div class="g-content g-content-footer">
      ...
      <div class="course-cnt">
        <h3>
          <i class="bt" style="height: 20px;vertical-align: -5%;"></i>
          {{infoData.nm}}
        </h3>
        ...
        <div class="s-sytle clearfix">
          ...
          <div>
            <p
              ...
              class="c-place"
            >时间：{{item.weekNm}}&nbsp;{{item.periNm}}&nbsp;&nbsp;&nbsp;&nbsp;地点：{{item.roomNm}}</p>
          </div>
        </div>
        <div class="s-sytle clearfix">
          <h4>
          ...
          <div>
            <p
              class="c-place"
            >男：{{infoData.maleAgeNm}}岁&nbsp;&nbsp;&nbsp;&nbsp;女：{{infoData.famaleAgeNm}}岁</p>
          </div>
        </div>
        <div class="s-sytle clearfix">
        ...
        <div class="s-sytle clearfix">
          ...
          <div>
            <p class="c-place">{{pSTime}}&nbsp;&nbsp;~&nbsp;&nbsp;{{pETime}}</p>
          </div>
        </div>
        <div class="s-sytle clearfix" v-if="!teachData.intro==''">
          ...
          <div>
            <p class="c-place">{{teachData.intro}}</p>
          </div>
        </div>
        <div class="s-sytle clearfix">
          <h4>
  ...
  methods: {
    ...
    getClassinfo() {
      return new Promise(resolve => {
        ...
        this.until.get("/px/clazzLesson/list", clazzParam).then(res => {
          if (res.status == 200) {
    ...
    getTeachInfo() {
      return new Promise(resolve => {
        this.until.get("/px/teac/info/" + this.teacPk, {}).then(res => {
          if (res.status == 200) {
